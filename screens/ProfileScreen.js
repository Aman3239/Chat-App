...
const ProfileScreen = () => {
  ...
  return (
    <SafeAreaView>
          ...
          <View style={{marginTop:10}}>
            <Pressable>
              <Image
                ...
                source={{ uri: "https://lh3.googleusercontent.com/ogw/AF2bZyjAblSUK2UCzLcJccIxE4lN23n1uZK6jkze9M3KZsnyNwE=s32-c-mo" }}
              />
      ...
      <View style={{padding:10}}>
        <Text style={{fontSize:15,fontWeight:"bold"}}>Chennels</Text>
        {channels.map((item,index)=>(
          <View style={{marginVertical:10,flexDirection:"row",alignItems:"center",gap:12,padding:1}}>
            <View>
              <Image
